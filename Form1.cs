...
namespace GuildWars2_Launcher
{
    public partial class Form1 : Form
    {
        ...
        private void PopulateData()
        {
            ...
            if (dgv_Accounts.SelectedRows.Count > 0) { currRow = dgv_Accounts.SelectedRows[0].Index; }
            ...
            dgv_Accounts.Rows[currRow].Selected = true;
        ...
        private void Login()
        {
            ...
            string email = this.dt.Rows[currentRowIndex][2].ToString();
            string password = this.dt.Rows[currentRowIndex][3].ToString();
            string lastLogin = this.dt.Rows[currentRowIndex][6].ToString();
            ...
            this.dt.Rows[currentRowIndex][6] = updatedDate.ToString();
